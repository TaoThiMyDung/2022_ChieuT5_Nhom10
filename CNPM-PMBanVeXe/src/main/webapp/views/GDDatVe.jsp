...
<div id="content">
    ...
    <div id="step-3" class="step">
            ...
            <form action="dat-ve" id="form-book-ticket" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="full-name" type="text" name="hoTen"
                           value="${requestScope.khachHang != null? requestScope.khachHang.hoTen:""}">
                    <p class="form-error"></p>
                </div>
                <div class="form-group">
                    <label for="phone">Số điện thoại</label>
                    <input id="phone" type="text" name="Sodt"
                           value="${requestScope.khachHang != null? requestScope.khachHang.sdt:""}">
                    <p class="form-error"></p>
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input id="email" type="text" name="gmail"
                           value="${requestScope.khachHang != null? requestScope.khachHang.email:""}">
                    <p class="form-error"></p>
                </div>
                <div class="form-group">
                    <label for="address">Địa chỉ</label>
                    <input id="address" type="text" name="DiaChi"
                           value="${requestScope.khachHang != null? requestScope.khachHang.diaChi:""}">
                    <p class="form-error"></p>
                </div>
            </form>
        </div>
        <div class="step-actions">
            <div class="btn btn-back my-hover">Quay lại</div>
            <button type="submit" form="form-book-ticket" value="submit" class="btn btn-payment my-hover">Đặt vé
            </button>
        </div>
    </div>
</div>
